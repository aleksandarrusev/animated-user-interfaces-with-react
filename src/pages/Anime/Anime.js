...
class Anime extends React.Component {
  ...
  componentDidMount() {
    ...
    document.addEventListener('scroll', e => {
      if (isInViewport(this.cardsContainerRef.current) && !this.state.scrolledToCards) {
        this.setState({
          ...
          <div className="page-container">
            <div className="scroll-container">
              <div className="image-box" ref={this.imageBoxRef}>
                <div className="image-box-overlay" ref={this.imageBoxOverlayRef}/>
              </div>
                ...
                {this.cards.map(card => (
                    <div className="card">
                      <h3 className="card-title">
                        <span className="card-revealing-text">{card.title} </span>
                      </h3>
